...
type Solutions011_020() =
    ...
    member this.Solution013 =
        ...
        source
        |> List.map System.Numerics.BigInteger.Parse
...
"""
    ...
    member this.Solution019 =
        [|1901..2000|]
        |> Array.collect (fun y -> [|1..12|] |> Array.map (fun m -> m, y))
